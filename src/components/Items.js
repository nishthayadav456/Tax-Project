          ...
          <div className="w-3/4 ">
            <div className="border shadow-lg m-1 p-2">
              ...
              <div className="text-xs">
                <div className="flex justify-between my-2">
                  <h2>
                    SALE PRICE: <span className="text-green-500"> ₹ 0.00 </span>
                    (excl)
                  </h2>
                  <h2>
                    STOCK QUANTITY <span className="text-blue-500">0</span>
                  </h2>
                </div>
                <div className="flex justify-between my-2">
                  <h2>
                    PURCHASE PRICE:{" "}
                    <span className="text-green-500"> ₹ 0.00 </span>(excl)
                  </h2>
                  <h2>
                    STOCK VALUE:{" "}
                    <span className="text-green-500"> ₹ 0.00 </span>(excl)
                ...
                <div className="m-6 text-sm border-b py-2">
                  ...
                  <div className="flex justify-between items-center  ">
                    ...
                    <input
                      ...
                      name="input-name"
                      title="Inpit title"
                      placeholder="Adjustment Date" onChange={changeHandle} 
                    />
                  </div>
                </div>
                <div className="relative p-6 flex">
                  <div class="input_container mx-2 ">
                    ...
                    <input
                      ...
                      type="text"
                      name="input-name"
                      title="Inpit title" onChange={changeHandle}
                    />
                  </div>
                  <div class="input_container mx-2 ">
            ...
            <div className="relative w-auto my-6 mx-auto">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="relative p-6 flex">
                  <div class="input_container mx-2 ">
                    ...
                    <input
                      ...
                      type="text"
                      name="category"
                      title="Input title"  value={data.category} onChange={changeHandle}
                    />
                  </div>
                  <div class="input_container mx-2 ">
                  ...
                  <div class="input_container mx-2 ">
                    ...
                    <input
                      ...
                      name="Brand"
                      title="Input title"
                      placeholder=""  value={data.Brand} onChange={changeHandle}
                    />
                  </div>
                </div>
                ...
                <div className="p-6">
                      ...
                      <div className="p-6 flex">
                        ...
                        <div class="input_container mx-2 ">
                          ...
                          <input
                            ...
                            name="wholesalePrice"
                            title="Input title"
                            placeholder="Wholesale Price" value={data.wholesalePrice} onChange={changeHandle}
                          />
                        </div>
                      </div>
                      <div className="p-6 flex">
                      ...
                      <div className="p-6 flex">
                        ...
                        <div class="input_container mx-2 ">
                          ...
                          <input
                            ...
                            name="location"
                            title="Input title"
                            placeholder="Location" value={data.location} onChange={changeHandle}
                          />
                        </div>
                      </div>
                    </div>
                  ...
                  {viewInputs === "manufacturing" && <div></div>}
                </div>

...
const PurchaseOrder = () => {
  ...
  const [data1,setData1]=useState({
        ...
        addDescription:"",
        discount: [{ discountRatet:"", discountAmount:"" }],
        tax: "",
        roundOff: "",
        total: "",
        advanceAmount:"",
  ...
  const handleClick=async()=>{
    ...
    try{
        const requestData={
            ...
            orderNumber:data1.orderNumber,
            orderDate:data1.orderDate,
            time:data1.time,
    ...
    const fetchData = async () => {
      try {
        ...
        const getDataResponse = await axios.get(
          "https://ca-backend-api.onrender.com/:firmId/purchaseOrder/getAll",
          { headers }
        );

        setpurchaseOrderData(getDataResponse.data.data);
  ...
  return (
    <>
      <h2 className="text-xl font-bold my-3 mx-6">Purchase Order</h2>
      <div className="p-6">
          ...
          <div className="">
            <div class="input_container">
              ...
              <input
                ...
                type="number"
                name="orderNumber"
                placeholder="Ref no"  value={data1.orderNumber}
            ...
            <div class="flex justify-between items-center my-2">
              ...
              <input
                ...
                type="date"
                name="orderDate"
                placeholder="Invoice Date" value={data1.orderDate}
                onChange={changeHandle}
              />
            </div>
            <div class="flex justify-between items-center my-2">
              ...
              <input
                ...
                type="date"
                name="dueDate"
                placeholder="Invoice Date" value={data1.dueDate}
                onChange={changeHandle}
              />
            </div>
          </div>
                  ...
                  <tr className="">
                    ...
                    <td>
                      <input
                        ...
                        value={item.EXPDate}
                        onChange={(e) =>
                          handleItemChange(index, "EXPDate", e.target.value)
                        }
                      />
                    </td>
                    <td>
                      <input
                        ...
                        value={item.MFGDate}
                        onChange={(e) =>
                          handleItemChange(index, "MFGDate", e.target.value)
                        }
                      />
                    </td>
                    <td>
        ...
        <div className="w-3/6 border rounded-lg p-4 my-2">
          {addPaymentType.map((field, index) => (
            <div className="flex justify-center items-center" key={index}>
              ...
              >
                <svg
                  class="w-4 h-4 font-semibold text-gray-800 dark:text-gray-600"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"

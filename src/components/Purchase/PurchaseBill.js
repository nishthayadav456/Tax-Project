...
const PurchaseBill = () => {
  ...
  const [addPaymentType, setAddPaymentType] = useState([
    { paymentType: "", referenceNo: "", amount: "" },
  ]);
  ...
  const [data1,setData1]=useState({
          ...
          paymentType: [
            {
              cash:"",
              cheque: { refreanceNo:"", checkAmount:"" },
              bankDetail: {
                accountName: "",
                openingBalance: "",
                asOfDate: "",
          ...
          const handleClick=async()=>{
            ...
            try{
                const requestData={
                    ...
                    sale: 
                      {
                        category:data1.sale[0].category,
                        itemName:data1.sale[0].itemName,
                        itemCode:data1.sale[0].itemCode,
                        hsnCode:data1.sale[0].hsnCode,
                        serialNo:data1.sale[0].serialNo ,
                        description:data1.sale[0].description ,
                        batchNo:data1.sale[0].batchNo ,
                        modelNo:data1.sale[0].modelNo ,
                        expDate:data1.sale[0].expDate ,
                        mfgDate:data1.sale[0].mfgDate ,
                        customField:data1.sale[0].customField ,
                        size:data1.sale[0].size ,
                        qty:data1.sale[0].qty ,
                        unit:data1.sale[0].unit,
                        periceUnitWithTex:data1.sale[0].periceUnitWithTex ,
                        periceUnitWithoutTex:data1.sale[0].periceUnitWithoutTex ,
                        discountpersant:data1.sale[0].discountpersant,
                        discountAmount:data1.sale[0].discountAmount ,
                        taxPersant:data1.sale[0].taxPersant ,
                        taxAmount: data1.sale[0].taxAmount,
                        amount:data1.sale[0].amount,
                      },
     ...
     const fetchData = async () => {
      try {
        ...
        const getDataResponse = await axios.get(
          "https://ca-backend-api.onrender.com/:firmId/purchase/getAll ",
          { headers }
        );

        setpurchaseBillData(getDataResponse.data.data);
  ...
  const filteredParties = ["Party1"].filter((item) =>
      ...
      <div className="p-6">
        <div className="flex justify-between">
          <div className="mx-2 flex justify-center items-start">
            ...
            <input
              className="border-2 rounded hover:border-black focus:border-blue-500 px-2 py-1 outline-none mx-2"
              type="text"
              name="phoneNumber"
              title="Input title"
              placeholder="Phone Number" value={data1.phoneNumber}
          ...
          <div className="">
            <div class="input_container">
              ...
              <input
                class="border-2 rounded hover:border-black focus:border-blue-500 px-2 py-1 outline-none mx-2"
                type="number"
                name="billNumber"
                placeholder="Ref no" value={data1.billNumber}
                onChange={changeHandle}
              />
            </div>
            <div class="flex justify-between items-center my-2">
              ...
              <input
                ...
                type="date"
                name="billDate"
                placeholder="Invoice Date" value={data1.billDate}
                onChange={changeHandle}
              />
            </div>
          </div>
                ...
                {addItems.map((item, index) => (
                  <tr className="">
                    ...
                    <td>
                      <button
                        onClick={() =>
                          setShowAddSerialNoModal(!showAddSerialNoModal)
                        }
                      >
                        <svg
        ...
        <div className="w-3/6 border rounded-lg p-4 my-2">
            ...
            <div className="flex justify-center items-center" key={index}>
              ...
              <div className="input_container mx-2 ">
                ...
                <input
                  ...
                  value={field.amount}
                  onChange={(e) =>
                    handlePaymentTypeChange(index, "amount", e.target.value)
                  }
                />
              </div>
              <button
                className="text-white bg-gray-600 p-2 m-2 rounded"
                onClick={() => removePaymentFunc(index)}
              >
                <svg
                  class="w-4 h-4 font-semibold text-gray-800 dark:text-white"
                  aria-hidden="true"
          ...
          <button
            className="text-white bg-blue-400 px-2 py-1 rounded m-2"
            onClick={addPaymentFunc}
          >
            {" "}
            + Add Payment Type
          </button>

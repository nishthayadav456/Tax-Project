                ...
                <div className='flex justify-between'>
                    ...
                    <div className=''>
                        <div class="flex justify-between items-center my-2">
                            <label class="input_label">Return No</label>
                            <input class="border-2 rounded hover:border-black focus:border-blue-500 px-2 py-1 outline-none mx-2" type="number" name="input-name" placeholder="Return No" />
                        </div>
                        <div class="flex justify-between items-center my-2">
                            <label class="input_label">Bill Number</label>
                            <input class="border-2 rounded hover:border-black focus:border-blue-500 px-2 py-1 outline-none mx-2" type="number" name="input-name" placeholder="Bill Number" />
                        </div>
                        <div class="flex justify-between items-center my-2">
                            <label class="input_label">Bill Date</label>
                            <input class="border-2 rounded hover:border-black focus:border-blue-500 px-2 py-1 outline-none mx-2" type="date" name="input-name" placeholder="Bill Date" />
                        </div>
                        <div class="flex justify-between items-center my-2">
                            <label class="input_label">Date</label>
                            <input class="border-2 rounded hover:border-black focus:border-blue-500 px-2 py-1 outline-none mx-2" type="date" name="input-name" placeholder="Date" />
                        </div>
                    </div>
                </div>

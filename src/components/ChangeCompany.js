...
const ChangeCompany = ({ showChangeCompanyModal, setShowChangeCompanyModal, setNewCompany }) => {
    return (
        <>
                ...
                <div className="relative w-3/5 my-6 mx-auto">
                    ...
                    <div className="border-0 shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        <div className='bg-gray-100 px-6 py-3 h-96'>
                            ...
                            <div className='flex justify-between items-center p-6 bg-white h-12 shadow rounded py-8'>
